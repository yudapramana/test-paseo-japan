...
<main id="main" class="main">
    ...
    @include('admin.testimony._modal')
...
<script>
    ...
    var coverWidget = cloudinary.createUploadWidget({
        ...
        if (!error && result && result.event === "success") {
            ...
            $('#new-profile_url').val(linklogo);

            $('#profile_url_btn').hide();
    ...
    document.getElementById("profile_url_btn").addEventListener("click", function() {
        coverWidget.open();
    }, false);
    ...
    var table = $('#example').DataTable({
        ...
        , }, {
            ...
            data: 'profile_url_can'
            , name: 'profile_url_can'
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            console.log(data);
            $("#id_testimony").val(data.id_testimony);
            ...
            $('#new-profile_url').val(data.profile_url);
            $('#profile_url_btn').hide();
            $('.show-cover-box').show();
            $('#preview-cover').attr("src", data.profile_url);
